...
function cmb2_get_oembed( $args = array() ) {
	...
	$error = sprintf( __( 'No oEmbed Results Found for %s. View more info at %s', 'wp-coupon' ), $oembed['fallback'], ' <a href="http://codex.wordpress.org/Embeds" target="_blank">codex.wordpress.org/Embeds</a>.' );
